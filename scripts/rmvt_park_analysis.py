...
if __name__ == "__main__":
    ...
    parser.add_argument('--fullgt', default='/mnt/d/dataset/dynamic_self/test/park_res_wo_fusion_res_full__to__voxel_0.200000.pcd', type=str)    
    parser.add_argument('--fullest', default='/mnt/d/dataset/dynamic_self/test/removert_park/map_static/StaticMapScansideMapGlobal.pcd', type=str)
