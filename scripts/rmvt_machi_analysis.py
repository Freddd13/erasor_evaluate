...
if __name__ == "__main__":
    ...
    parser.add_argument('--fullest', default='/mnt/d/dataset/dynamic_self/test/removert_machi/map_static/StaticMapScansideMapGlobal.pcd', type=str)
    parser.add_argument('--fullgt', default='/mnt/d/dataset/dynamic_self/test/machi_no_distort_featurori_config1_full_filter_res_full__to__voxel_0.200000.pcd', type=str)    
